...
def convert():
    ...
    with open(os.path.join(CSV_OUTPUT_FOLDER, "out.csv"), "w", encoding="utf-8", newline="") as out, open(
        os.path.join(CSV_OUTPUT_FOLDER, "output_detail.json"), "r", encoding="utf-8"
    ) as detail:
